...
impossible because the Elf showed you 15 blue cubes at once. If you add up the IDs of 
...
# Define constants, variables, etc
cubes = {12:"red",13:"green",14:"blue"}


def games(line): 
    # Remove Game number and start after   
    index = line.find(":")
    #print("Results = ",line[index+1::])
    game = line[index+1::]
    return game

def validateGame(list):
    mg = list.split(";")
    for x in mg: 
